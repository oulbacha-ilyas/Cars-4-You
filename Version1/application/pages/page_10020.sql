...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(907800458250790893)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(907800559996790893)
,p_plug_name=>'Configure Appearance'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(907660996065790939)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(907802206539790892)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(907800458250790893)
,p_button_name=>'SAVE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(907801761728790892)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(907802691307790892)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(907802976312790892)
,p_name=>'P10020_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(907800559996790893)
...
,p_field_template=>wwv_flow_api.id(907754586872790912)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(907803610760790891)
...
,p_lov=>'.'||wwv_flow_api.id(907803751651790891)||'.'
,p_grid_label_column_span=>0
,p_field_template=>wwv_flow_api.id(907754289266790912)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(907800715959790893)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(907801761728790892)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(907805198883790890)
,p_event_id=>wwv_flow_api.id(907800715959790893)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(907805642996790890)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(907806010897790890)
