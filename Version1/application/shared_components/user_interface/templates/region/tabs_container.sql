...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(907698740282790928)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(907699040383790928)
,p_plug_template_id=>wwv_flow_api.id(907698740282790928)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(907699389604790928)
,p_plug_template_id=>wwv_flow_api.id(907698740282790928)
,p_name=>'Tabs'
