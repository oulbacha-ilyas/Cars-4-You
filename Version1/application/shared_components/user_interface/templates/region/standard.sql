...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(907691984613790930)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(907692279246790930)
,p_plug_template_id=>wwv_flow_api.id(907691984613790930)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(907692574731790930)
,p_plug_template_id=>wwv_flow_api.id(907691984613790930)
,p_name=>'Sub Regions'
