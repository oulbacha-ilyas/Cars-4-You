...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(907661992914790939)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(907662284010790939)
,p_plug_template_id=>wwv_flow_api.id(907661992914790939)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(907662575158790939)
,p_plug_template_id=>wwv_flow_api.id(907661992914790939)
,p_name=>'Sub Regions'
